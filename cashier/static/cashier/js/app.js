...
async function loadProducts(){
  ...
  productGrid.innerHTML = `<div class="empty-state"><i class="bi bi-hourglass-split"></i><p>جاري تحميل المنتجات...</p></div>`;
  ...
  try{
    ...
    productGrid.innerHTML = `<div class="empty-state"><i class="bi bi-wifi-off"></i><p>تعذر تحميل المنتجات</p></div>`;
  }
}
...
function renderProducts(){
  ...
  if(products.length === 0){
    box.innerHTML = `<div class="empty-state"><i class="bi bi-box"></i><p>لا توجد منتجات متاحة</p></div>`;
    return;
  }
...
function renderCart(){
  ...
  if(cart.length === 0){
    box.innerHTML = `<div class="empty-state"><i class="bi bi-cart"></i><p>لم يتم اختيار أي منتج</p></div>`;
  ...
  box.innerHTML = cart.map(item => `
    <div class="cart-item">
      ...
      <div class="text-end">
        ...
        <button class="btn btn-sm btn-outline-primary py-0 px-2" onclick="changeQty(${item.id}, -1)">-</button>
        <button class="btn btn-sm btn-outline-primary py-0 px-2" onclick="changeQty(${item.id}, 1)">+</button>
      </div>
    </div>
  `).join('');
